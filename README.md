# Django v5.x - [Datta Able](https://appseed.us/product/datta-able/django/)

Open-source **Django Dashboard** generated by `AppSeed` on top of a modern design. **[Datta Able](https://appseed.us/product/datta-able/django/)** Bootstrap Lite is the most stylized Bootstrap 4 Template, among all other Lite/Free admin templates in the market. It comes with high feature-rich pages and components with fully developer-centric code - design from [CodedThemes](https://codedthemes.com/?ref=appseed).

- 👉 [Django v5.x Datta Able](https://django-v5-datta.onrender.com) - `LIVE demo` 
- 🚀 Get [Support](https://appseed.us/support/) via Email & [Discord](https://discord.gg/fZC6hup)
 
<br />

> Features: 

- ✅ `Up-to-date Dependencies` - **Django x5.x**
